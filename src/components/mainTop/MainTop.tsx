    ...
    return (
        <section className={styles.homeTop}>
            <div className={styles.left}>
                <Headline headline="h1" size={HeadlineSize.L} className={styles.headline}>Hi,<br />I&apos;m <span className={styles.name}>Muslim</span> Zamukave<br /> Front End Develop<span className={styles.dev}>e</span>r</Headline>
